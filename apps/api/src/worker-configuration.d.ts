/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 13f29b3243e0ca262d2bf11ad429360b)
...
interface __BaseEnv_Env {
  ...
  R2_BUCKET_NAME: 'dropthing-local';
  R2_PREFIX: 'local';
  DB_URL: string;
  USE_R2: string;
  R2_ENDPOINT: string;
